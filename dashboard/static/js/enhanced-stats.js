...
function initEnhancedStats() {
    ...
    fetch('/api/stats')
        ...
        .then(data => {
            ...
            if (data) {
                console.log('Stats-Daten erhalten:', data);
...
function loadResolutionCharts() {
    fetch('/api/stats/resolution')
        ...
        .then(data => {
            console.log('Auflösungsdaten erhalten:', data);
...
function loadCodecCharts() {
    fetch('/api/stats/codec')
        ...
        .then(data => {
            console.log('Codec-Daten erhalten:', data);
...
function loadHDRChart() {
    fetch('/api/stats/hdr?chart=true')
        ...
        .then(data => {
            console.log('HDR-Daten erhalten:', data);
...
function loadStorageChart() {
    fetch('/api/stats/resolution')
        ...
        .then(data => {
            console.log('Speicherdaten erhalten:', data);
...
function loadContainerChart() {
    fetch('/api/container')
        ...
        .then(data => {
            console.log('Container-Daten erhalten:', data);
...
function loadTopAnimes(sortBy) {
    ...
    fetch(`/api/stats/top_animes?sort_by=${sortBy}`)
        ...
        .then(data => {
            console.log(`Top-Animes (${sortBy}) erhalten:`, data);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.querySelector('.stats-dashboard') && !statsInitialized) {
        ...
        console.log('Starte Initialisierung der erweiterten Statistiken...');
        initEnhancedStats();
    }
});
